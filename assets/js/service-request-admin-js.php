 ...
 jQuery('#enoderit_cuctom_form_admin_file_submit').on('click',function(e)
    {
      ...
      formdata.append('action','fenix_people_admin_file_submit');
      formdata.append('nonce','<?php echo wp_create_nonce('fenix_people_admin_file_submit') ?>')
      jQuery.ajax({
        ...
        success: function(data) {
                      ...
                      console.log(obj);
                        ...
                        if (obj.success == "success") {
                            ...
                            window.location.href='<?=admin_url() .'admin.php?page=fenix-people-service-request'?>'
                        }

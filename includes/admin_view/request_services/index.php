...
class EncoderITCustomForm extends WP_List_Table
{
    ...
    {
        return array(
                    'Submitted Request.'=>array('Submitted Request.',true),
                    );
    }
    ...
    private function table_data()
    {
        ...
        if (count($result) != 0) {
            ...
            foreach ($result as $singledata) {
                ...
                $data[] = array(
                    'Submitted Request.'                    => '#'.$singledata->id,
                   ...
                   // 'Country'             =>enc_get_country_name_by_id($singledata->country_id),
                    ...
                    'Action'                    => '<a  href="' .admin_url() .'admin.php'. '?page=fenix-people-service-request-details-view-admin&id=' . $singledata->id . '" class="button" target="_blank" style="background-color: #009B00;color: black">Details</a>
                    ',
...
<div class="wrap pbwp">
    <div>
        <h1 class="pbwp-headingtag pbwp-mb-4 pbwp-p-1">All Submitted Requests</h1>
    </div>
    <div class="pbwp-mt-3">

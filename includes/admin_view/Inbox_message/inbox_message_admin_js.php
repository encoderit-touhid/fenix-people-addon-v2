...
jQuery('#send_message_by_admin_btn').on('click',function(e){
        ...
        }else
        {
            ...
            formdata.append('action','fenix_people_message_by_admin_with_subject');
            formdata.append('receiver_id',<?=$client_id?>)
            formdata.append('subject_id',<?=$subject_id?>)
            formdata.append('nonce','<?php echo wp_create_nonce('fenix_people_message_by_admin_with_subject') ?>')
